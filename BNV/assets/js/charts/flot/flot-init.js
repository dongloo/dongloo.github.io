...
var InitiatePieChart = function () {
    return {
        init: function () {
            ...
            var data = [
            	{ label: "Phần mềm", data: [[1, 15]], color: themefifthcolor },
            	{ label: "KDPP", data: [[1, 20]], color: themesecondary },
            	{ label: "Số hóa", data: [[1, 35]], color: themethirdcolor },
            	{ label: "Loại dự án 4", data: [[1, 20]], color: themefourthcolor }
            ];
            ...
            function labelFormatter(label, series) {
                return "<div style='font-size:26pt; text-align:center; padding:2px; color:white;'>" + label + "<br/>" + Math.round(series.percent) + "%</div>";
            }
