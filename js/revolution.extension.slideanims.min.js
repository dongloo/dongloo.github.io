	...
	var e = function(e, o, a, i) {
		...
		o = function(t, e, o, a, i) {
			...
			var r = punchgs.Power1.easeIn,
				...
				x = 0,
				y = (new Array, [
					["boxslide", 0, 1, 10, 0, "box", !1, null, 0, s, s, 500, 6], // ok
					["boxfade", 1, 0, 10, 0, "box", !1, null, 1, l, l, 700, 5], // ok

					["slotslide-horizontal", 2, 0, 0, 200, "horizontal", !0, !1, 2, f, f, 700, 3], // ok
					["slotslide-vertical", 3, 0, 0, 200, "vertical", !0, !1, 3, f, f, 700, 3], // ok

					["curtain-1", 4, 3, 0, 0, "horizontal", !0, !0, 4, s, s, 300, 5], // ok 
					["curtain-2", 5, 3, 0, 0, "horizontal", !0, !0, 5, s, s, 300, 5], // ok 
					["curtain-3", 6, 3, 25, 0, "horizontal", !0, !0, 6, s, s, 300, 5], // ok 

					["slotzoom-horizontal", 7, 0, 0, 400, "horizontal", !0, !0, 7, s, s, 300, 7], // ok
					["slotzoom-vertical", 8, 0, 0, 0, "vertical", !0, !0, 8, h, h, 500, 8], // ok
					["slotfade-horizontal", 9, 0, 0, 500, "horizontal", !0, null, 9, h, h, 500, 25], // ok
					["slotfade-vertical", 10, 0, 0, 500, "vertical", !0, null, 10, h, h, 500, 25], // ok
					...
					["slideremoveleft", 12, 8, 1, 0, "horizontal", !0, !0, 12, p, p, 1e3, 1], // ok
					["slideremoveup", 13, 8, 1, 0, "horizontal", !0, !0, 13, p, p, 1e3, 1], // ok
					["slideremovedown", 14, 8, 1, 0, "horizontal", !0, !0, 14, p, p, 1e3, 1], // ok
					["slideremoveright", 15, 8, 1, 0, "horizontal", !0, !0, 15, p, p, 1e3, 1], // ok

					["papercut", 16, 0, 0, 600, "", null, null, 16, p, p, 1e3, 2], // ok
					["3dcurtain-horizontal", 17, 0, 20, 100, "vertical", !1, !0, 17, l, l, 500, 7], // ok
					["3dcurtain-vertical", 18, 0, 10, 100, "horizontal", !1, !0, 18, l, l, 500, 5], // ok
					["cubic", 19, 0, 20, 600, "horizontal", !1, !0, 19, p, p, 500, 1], // ok
					["cube", 19, 0, 20, 600, "horizontal", !1, !0, 20, p, p, 500, 1], // ok
					["flyin", 20, 0, 4, 600, "vertical", !1, !0, 21, c, p, 500, 1], // ok

					["turnoff", 21, 0, 1, 500, "horizontal", !1, !0, 22, p, p, 500, 1], // ok
					["incube", 22, 0, 20, 200, "horizontal", !1, !0, 23, f, f, 500, 1], // ok
					["cubic-horizontal", 23, 0, 20, 500, "vertical", !1, !0, 24, h, h, 500, 1], // ok
					["cube-horizontal", 23, 0, 20, 500, "vertical", !1, !0, 25, h, h, 500, 1], // ok
					["incube-horizontal", 24, 0, 20, 500, "vertical", !1, !0, 26, f, f, 500, 1], // ok
					["turnoff-vertical", 25, 0, 1, 200, "horizontal", !1, !0, 27, f, f, 500, 1], // ok
		...
		i = function(t, i, n, r, s, l, d, h, f) {
			...
			if (27 == t || 28 == t || 29 == t || 30 == t) {
				var P = d.find(".slot"),
					...
					q = 1 == Q ? "y" : "x";
				_[q] = "0px", C[q] = O, V[q] = S, Z[q] = "0%", H[q] = I, J[q] = O, N[q] = X, R[q] = Y, P.append('<span style="background-color:rgba(0,0,0,0.025);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), f.add(punchgs.TweenLite.fromTo(h, y / 1e3, _, C), 0), f.add(punchgs.TweenLite.fromTo(d.find(".defaultimg"), y / 2e3, V, Z), y / 2e3), f.add(punchgs.TweenLite.fromTo(P, y / 1e3, H, J), 0), f.add(punchgs.TweenLite.fromTo(P.find(".slotslide div"), y / 1e3, N, R), 0)
			}
			...
			if (11 == t) {
				m > 4 && (m = 0);
				var M = 0,
					E = 2 == m ? "#000" : 3 == m ? "#ffffff" : "transparent";
				switch (m) {
					case 0:
